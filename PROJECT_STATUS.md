...
Last updated: 2026-05-28 (HISTORY#269 - audit-driven correctness slice: pool reset-on-return P1 fix, `seam bench publish` gate + HMAC bundle signing, durable LoCoMo result archiving with per-scope checkpoints; #3 retrieval scoring deferred on missing dataset)
